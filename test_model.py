...
test_train = "The model should be a RandomForestClassifier instance"
...
def test_train_model(sample_data):
    ...
    assert isinstance(
        model,
        RandomForestClassifier), test_train
...
test_assert = "Number of predictions should match the number of test samples"
...
def test_inference(sample_data):
    ...
    assert preds.shape[0] == X_test.shape[0], test_assert
